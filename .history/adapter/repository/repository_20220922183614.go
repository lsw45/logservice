...
func SetRepoInfra(Redis infra.RedisInfra, Mysql infra.MysqlInfra, Opensearch infra.OpensearchInfra, Tunnel infra.TunnelInfra, Elastic infra.ElasticsearchInfra) {
	once.Do(func() {
		defaultInfra = &RepoInfra{
			Mysql:      mysql,
			Redis:      redis,
