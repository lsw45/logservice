...
func (elas *ElasticsearchRepo) SearchRequest(indexNames []string, query *entity.QueryDocs) ([]*elastic.SearchHit, error) {
	res, err := this.ElasticsearchInfra.SearchRequest(indexNames, query)
	if err != nil {
		return nil, err
	}
